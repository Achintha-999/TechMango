        ...
        if (Util.isInteger(productId)) {
            ...
            try {
                ...
                if (product != null) {
                    ...
                    String categoryName = product.getCategory().getValue();
                    if ("Laptop".equalsIgnoreCase(categoryName) || "Desktop".equalsIgnoreCase(categoryName)) {
                        Criteria cVar = s.createCriteria(ProductVariant.class);
                        cVar.add(Restrictions.eq("productl", product));
                        List<ProductVariant> variantList = cVar.list();
                        responseObject.add("variantList", gson.toJsonTree(variantList));
                    }
