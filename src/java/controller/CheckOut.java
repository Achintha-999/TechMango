...
public class CheckOut extends HttpServlet {
    ...
    private void processCheckout(Session s,
        ...
        try {
            ...
            OrderStatus orderStatus = (OrderStatus) s.get(OrderStatus.class, CheckOut.ORDER_PAID);
            ...
            //PayHere process
            String merahantID = "1224939";
            String merchantSecret = "MjkzNzAyMDI3MzI1NzM4MzQ1ODc1MDk3OTU5NzAyNjMxNjU3Mjg=";
            ...
            payHereJson.addProperty("notify_url", "https://55954bec92ee.ngrok-free.app/TechMango/VerifyPayments");
